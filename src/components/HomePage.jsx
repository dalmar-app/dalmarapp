...
const HomePage = () => {
  ...
  // --- HALKAN EEG: Sawirkaaga oo ah koodh (Base64) ---
  const myPhotoCode = "https://avatars.githubusercontent.com/u/197945084?v=4"; 
...
const styles = {
  ...
  name: { fontSize: '28px', fontWeight: 'bold', color: '#f8fafc', marginBottom: '5px', cursor: 'pointer' },
  ...
  successCard: { backgroundColor: '#16a34a', padding: '30px', borderRadius: '25px', textAlign: 'center' },
  ...
  footer: { marginTop: 'auto', color: '#475569', fontSize: '12px', paddingTop: '20px' }
};
