...
const Home = () => {
  ...
  const requestTaxi = async () => {
    setLoading(true);
    // Halkan waxaan ka qaadaynaa goobta qofka (Location)
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Garoowe Taxi Service</p>

        {!sent ? (
          <div style={styles.actionArea}>
            <p style={styles.infoText}>Ma u baahan tahay gaari hadda? Hal riix uun baa kuu xiran.</p>
            <button 
              onClick={requestTaxi} 
              disabled={loading}
              style={loading ? styles.btnLoading : styles.btn}
            >
              {loading ? 'Raadinaya Goobtaada...' : 'Hadda Dalbo Gaari'}
            </button>
          </div>
        ) : (
          <div style={styles.successArea}>
            ...
            <p style={styles.successText}>Darawalka kuugu dhow ayaa kuu soo socda. Fadlan sug xoogaa.</p>
