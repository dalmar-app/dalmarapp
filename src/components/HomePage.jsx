...
const HomePage = () => { 
  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      alert("Si aad u shubato App-ka: Browser-ka (Chrome) ka dooro 'Add to Home Screen'.");
    }
  };
  ...
  return ( 
    <div style={styles.container}> 
      {/* Waa halkan wareegii iyo glow-gii aad sheegaysay saaxiib */}
      <style> 
        {` 
          @keyframes glow { 
      ...
      <div style={styles.appZone}> 
        {!isOrdered ? ( 
          <div style={styles.card}> 
            ...
            {/* BADHANKII INSTALL-KA AAD CODSATAY */}
